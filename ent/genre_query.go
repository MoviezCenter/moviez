...
func (gq *GenreQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (gq *GenreQuery) loadMovies(ctx context.Context, query *MovieQuery, nodes []*Genre, init func(*Genre), assign func(*Genre, *Movie)) error {
	...
	byID := make(map[int]*Genre)
	nids := make(map[int]map[*Genre]struct{})
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(movie.FieldID), joinT.C(genre.MoviesPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(genre.MoviesPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(genre.MoviesPrimaryKey[0]))
...
func (gq *GenreQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(genre.Table, genre.Columns, sqlgraph.NewFieldSpec(genre.FieldID, field.TypeInt))
	_spec.From = gq.sql
